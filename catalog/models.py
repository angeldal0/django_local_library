...
class Language(models.Model):
    """Model representing a language of a book collection."""
    name = models.CharField(
        max_length=100,
        unique=True,
        help_text="Enter a language (e.g. Español, English, etc.)"
    )
    ...
    class Meta:
        constraints = [
            UniqueConstraint(
                ...
                violation_error_message="Languange already exists"
                " (case insensitive match)"
            ),
        ]
